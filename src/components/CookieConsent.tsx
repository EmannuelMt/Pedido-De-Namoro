    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div 
          ...
          className="fixed bottom-8 left-8 z-[100] w-[calc(100vw-4rem)] max-w-[320px]"
        >
          <div className="[--shadow:rgba(0,0,0,0.5)_0_10px_30px_0] w-full h-auto rounded-[2.5rem] bg-zinc-900 border border-white/10 [box-shadow:var(--shadow)] overflow-visible">
            <div className="flex flex-col items-center justify-between pt-9 px-8 pb-8 relative">
              <span className="relative mx-auto -mt-20 mb-6 drop-shadow-2xl">
                <svg
              ...
              <h5 className="text-lg font-serif font-bold mb-3 text-white tracking-tight">
                Sua privacidade é importante
              </h5>

              <p className="w-full mb-6 text-sm text-white/50 leading-relaxed text-justify font-serif italic">
                Usamos cookies para melhorar sua experiência e garantir que nossa história seja preservada com segurança.
                <br />
                Para saber mais, consulte nossos{' '}
                <a className="cursor-pointer text-[var(--primary)] hover:opacity-80 underline underline-offset-4 transition-colors">
                  Termos de Uso
                </a>.
              </p>
              ...
              <div className="flex items-center justify-between w-full mt-2">
                ...
                <button
                  ...
                  className="py-3 px-10 bg-[var(--primary)] hover:opacity-80 text-white rounded-2xl font-bold transition-all shadow-lg shadow-[var(--primary-glow)] active:scale-95"
                  type="button"
                >
                  Aceitar
                </button>
